        ...
        <div className='flex flex-col items-center '>
          ...
          <form className='flex flex-col gap-2 justify-center items-center w-full'>
            <div className='flex flex-col gap-1'>
              ...
              <input type="text" id="username" name="username" placeholder="Enter your email" required className='flex px-2 py-1 rounded-md text-xs h-8 w-[30vh] sm:w-[35vh] border-2 border-blue-200 focus:outline-none hover:scale-105 transition-all' />
            </div>
            <div  className='flex flex-col gap-1'>
            ...
            <button type="submit" className='flex px-2 py-2 justify-center items-center font-semibold text-white bg-blue-500 rounded-md text-sm w-[30vh] sm:w-[35vh] focus:outline-none hover:bg-blue-700'>Sign up</button>
